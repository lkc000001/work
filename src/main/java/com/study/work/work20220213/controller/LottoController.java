package com.study.work.work20220213.controller;
...
import com.study.work.work20220213.service.LottoService;
...
public class LottoController {
	...
	public String index(Model model) {
		...
		model.addAttribute("lottoNumSum", lottoService.getLottoNumSum());
